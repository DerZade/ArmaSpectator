class zade_spectator_RscMap
{
     ...
     colorOutside[] = {1,1,1,1}; // Color outside of the terrain area (not sued when procedural terrain is enabled)
     ...
     fontLabel = "RobotoCondensedLight"; // Tooltip font from CfgFontFamilies
     ...
     fontInfo = "RobotoCondensedLight"; // Unknown?
